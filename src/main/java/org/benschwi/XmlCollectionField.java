 ...
 */
public record XmlCollectionField<A, B>(String name, String elementName, Function<A, Collection<B>> valueExtractor, XmlField<B, ?>...childFields) implements XmlNode<A> {
